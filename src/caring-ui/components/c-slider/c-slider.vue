<template>
	<view class="c-slider" @tap="onClick" :class="[disabled ? 'c-slider--disabled' : '']" :style="{
		...
		>
			<view class="c-slider__button-wrap" @touchstart="onTouchStart" 
				@touchmove="onTouchMove" @touchend="onTouchEnd" 
				@touchcancel="onTouchEnd">
				<slot v-if="$slots.default  || $slots.$default"/>
				<view v-else class="c-slider__button" :style="[blockStyle, {
...
export default {
	...
	mounted() {
		// 获取滑块条的尺寸信息
		this.$cGetRect('.c-slider').then(rect => {
