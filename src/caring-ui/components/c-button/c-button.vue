...
<template>
  ...
  >
    ...
    <view
      v-if="ripple"
      class="c-wave-ripple"
      :class="[waveActive ? 'c-wave-active' : '']"
      :style="{
        top: rippleTop + 'px',
        left: rippleLeft + 'px',
...
export default {
  ...
  props: {
    ...
    // 打开 APP 时，向 APP 传递的参数，open=launchApp时有效
    // 只微信小程序、QQ小程序有效
    appParameter: {
      type: String,
      default: ''
    ...
    // 会话来源，open="contact"时有效。只微信小程序有效
    sessionFrom: {
      type: String,
      default: ''
    },
    // 会话内消息卡片标题，open="contact"时有效
    // 默认当前标题，只微信小程序有效
    sendMessageTitle: {
      type: String,
      default: ''
    },
    // 会话内消息卡片点击跳转小程序路径，open="contact"时有效
    // 默认当前分享路径，只微信小程序有效
    sendMessagePath: {
      type: String,
      default: ''
    },
    // 会话内消息卡片图片，open="contact"时有效
    // 默认当前页面截图，只微信小程序有效
    sendMessageImg: {
      type: String,
      default: ''
    ...
    // 用户点击后可以快速发送小程序消息，open="contact"时有效
    showMessageCard: {
      type: Boolean,
      default: false
    },
  ...
  methods: {
    ...
    getElQuery() {
      return new Promise((resolve) => {
        ...
        //#endif
        queryInfo.select('.c-btn').boundingClientRect()
        queryInfo.exec((data) => {
          resolve(data)
        })
      })
...
.c-btn {
  ...
  &--success--disabled {
    ...
    background-color: $c-success-disabled !important;
  }

  &--error--disabled {
    color: #ffffff !important;
    border-color: $c-error-disabled !important;
    background-color: $c-error-disabled !important;
  }
...
.c-primary-plain-hover {
  color: #ffffff !important;
  background: $c-primary-dark !important;
}

.c-default-plain-hover {
  color: $c-primary-dark !important;
  background: $c-primary-light !important;
}

.c-success-plain-hover {
  color: #ffffff !important;
  background: $c-success-dark !important;
}

.c-warning-plain-hover {
  color: #ffffff !important;
  background: $c-warning-dark !important;
}

.c-error-plain-hover {
  color: #ffffff !important;
  background: $c-error-dark !important;
}

.c-info-plain-hover {
  color: #ffffff !important;
  background: $c-info-dark !important;
}

.c-default-hover {
  color: $c-primary-dark !important;
  border-color: $c-primary-dark !important;
  background-color: $c-primary-light !important;
}
